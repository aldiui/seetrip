...
class DestinationFacilityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/destination/' . $destination->uuid)->with('success', 'Destinasi Fasilitas Berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/destination/' . $destinationFacility->destination->uuid)->with('success', 'Destinasi Fasilitas Berhasil diubah');
    }
