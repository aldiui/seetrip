...
class DestinationPriceController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Destination/Price/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/destination/' . $destination->uuid)->with('success', 'Destinasi Harga Berhasil ditambahkan');
    }

    public function edit($uuid)
    {
        $destinationPrice = DestinationPrice::whereUuid($uuid)->firstOrFail();
        return Inertia::render('Admin/Destination/Price/Edit', compact('destinationPrice'));
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/admin/destination/' . $destinationPrice->destination->uuid)->with('success', 'Destinasi Harga Berhasil diubah');
    }
