...
class DestinationImageController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Destination/Image/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/destination/' . $destination->uuid)->with('success', 'Destinasi Gambar Berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/admin/destination/' . $destinationImage->destination->uuid)->with('success', 'Destinasi Gambar Berhasil diubah');
    }
