...
class DestinationFacilityController extends Controller
{
    ...
    {
        return Inertia::render('User/Destination/Facility/Create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/user/destination/' . $destination->uuid)->with('success', 'Destinasi Fasilitas Berhasil ditambahkan');
    }

    public function edit($uuid)
    {
        $destinationFacility = DestinationFacility::whereUuid($uuid)->firstOrFail();
        return Inertia::render('User/Destination/Facility/Edit', compact('destinationFacility'));
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/user/destination/' . $destinationFacility->destination->uuid)->with('success', 'Destinasi Fasilitas Berhasil diubah');
    }
