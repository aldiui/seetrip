...
class DestinationImageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/user/destination/' . $destination->uuid)->with('success', 'Destinasi Gambar Berhasil ditambahkan');
    }

    public function edit($uuid)
    {
        $destinationImage = DestinationImage::whereUuid($uuid)->firstOrFail();
        return Inertia::render('User/Destination/Image/Edit', compact('destinationImage'));
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/user/destination/' . $destinationImage->destination->uuid)->with('success', 'Destinasi Gambar Berhasil diubah');
    }
