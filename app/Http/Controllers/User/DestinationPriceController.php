...
class DestinationPriceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/user/destination/' . $destination->uuid)->with('success', 'Destinasi Harga Berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $uuid)
    {
        ...
        return redirect('/user/destination/' . $destinationPrice->destination->uuid)->with('success', 'Destinasi Harga Berhasil diubah');
    }
