...
const ShowCheckOut = ({ auth, sessions, checkOut, pembayaran }) => {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(`/check-out/${checkOut.nomor_pemesanan}`);
    };
    ...
    return (
        <AppLayout auth={auth} sessions={sessions}>
            <Head title="Detail Check Out" />
            <VStack mt={"90px"} maxW={"container.xl"} w="full">
                <Card p={2} maxW={"xl"} w="full" shadow={"md"}>
                    ...
                    <CardBody>
                        <SimpleGrid mb={2} gap={2} columns={2}>
                            ...
                            <Text>{checkOut.nomor_pemesanan}</Text>
                            <Text>Destinasi Wisata</Text>
                            <Text>
                                {checkOut.destination_price.destination.nama}
                            </Text>
                            <Text>Paket Wisata</Text>
                            <Text>{checkOut.destination_price.nama}</Text>
                            <Text>Kuantitas</Text>
                            <Text>{checkOut.quantitas} Orang</Text>
                            <Text>Total</Text>
                            <Text>{checkOut.total_custom} </Text>
                        </SimpleGrid>
                        {checkOut.wallet_id && (
                            <SimpleGrid mb={5} gap={2} columns={2}>
                                <Text>Nama Akun</Text>
                                <Text>{checkOut.wallet.nama_akun}</Text>
                                <Text>Nomor Rekening</Text>
                                <Text>{checkOut.wallet.nomor_rekening}</Text>
                                <Text>Nama Bank</Text>
                                <Text>{checkOut.wallet.nama_bank}</Text>
                                <Text>Status</Text>
                                <Text>
                                    {" "}
                                    <div>
