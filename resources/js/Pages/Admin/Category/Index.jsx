...
const Category = ({ auth, sessions, categories }) => {
    ...
    const calculateIndex = (index) => categories.from + index;

    const columns = [
        { header: "#", accessor: null, width: "5" },
        {
            header: "Avatar",
            accessor: "AvatarCategory",
            width: "20",
        },
        { header: "Nama", accessor: "nama" },
        { header: "Aksi", accessor: "Aksi", width: "10", uri: "/admin/category" },
    ];
                ...
                <CardBody>
                    ...
                    >
                        <Text color="gray.500" fontSize="sm">
                            ...
                            {categories.to ?? 0} of {categories.total ?? 0}
                        </Text>
